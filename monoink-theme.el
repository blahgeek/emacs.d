...
(custom-theme-set-faces
 'monoink
 '(default ((t (:family "Iosevka Ink" :foundry "FSD " :width normal :weight normal :slant normal
 ...
 '(header-line ((t (:box (:line-width (2 . 2) :color "gray80" :style unspecified) :background "gray80" :foreground "black" :underline (:color "gray80" :style line) :overline nil :inverse-video unspecified))))
 '(tooltip ((t (:inherit (default) :foreground "black" :background "gray90" :box 2))))
 '(mode-line ((t (:height 0.9 :underline (:color "gray80" :style line) :overline "gray80" :box (:line-width (1 . 1) :color "gray80" :style unspecified) :foreground "black" :background "gray80"))))
 ...
 '(mode-line-inactive ((t (:underline (:color "gray80" :style line) :overline "gray80" :box (:line-width (1 . 1) :color "gray80" :style unspecified) :foreground "black" :inherit (mode-line)))))
